  ...
  return (
    <section className="py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-6 space-y-16">
        ...
        {/* What I Did */}
        <AnimateOnScroll>
          <h2 className="text-xl font-bold text-text-primary mb-6">What I Did</h2>
        ...
        {project.challenges && project.solutions && (
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <AnimateOnScroll delay={0.1}>
              <div className="p-6 bg-bg-surface border border-accent/20 clip-corner h-full">
                <h3 className="text-lg font-bold text-text-primary mb-4">Solutions</h3>
                <ul className="space-y-3">
        ...
        {project.technologies && project.technologies.length > 0 && (
          <AnimateOnScroll>
            <h2 className="text-xl font-bold text-text-primary mb-4">Technologies</h2>
