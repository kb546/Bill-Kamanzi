...
export const projects: Project[] = [
  {
    ...
    year: '2025',
    category: ['Full-Stack SaaS', 'Next.js', 'AI/ML', 'Performance Marketing'],
    description: 'AI-powered ad arbitrage platform: niche discovery using Google Trends and Meta API data, creative generation with A/B testing, and campaign management dashboard.',
    longDescription: 'ArbHunter is a SaaS platform I built to automate the process of finding profitable ad arbitrage opportunities. It combines AI-powered niche discovery with real-time data from Google Trends and Meta\'s advertising API to surface high-potential opportunities, generate ad creatives, and manage campaigns from a single dashboard.',
    heroImage: '/images/projects/arbhunter/arbhunter-screenshot-homepage.png',
    logo: '/images/projects/arbhunter/icon-512-dark.png',
    images: [
      '/images/projects/arbhunter/arbhunter-screenshot-homepage.png',
    ],
    gradientFrom: '#3c71ec',
    gradientTo: '#2b5ad4',
    overview: 'The ad arbitrage space requires constant monitoring of trends, rapid creative testing, and data-driven decision making. ArbHunter automates these workflows, from discovering profitable niches to generating and testing ad creatives, giving marketers a significant edge in speed and accuracy.',
    myRole: [
      'Full-stack development (Next.js, TypeScript)',
      'AI/ML integration for niche discovery',
      'Google Trends & Meta API integration',
      'Campaign management dashboard design & build',
      'Creative generation pipeline with A/B testing',
      'Database architecture & deployment',
    ],
    results: [],
    services: ['Full-Stack Development', 'AI Integration', 'Product Design'],
    technologies: ['Next.js', 'TypeScript', 'Python', 'OpenAI API', 'Meta API', 'Google Trends', 'PostgreSQL', 'Tailwind CSS'],
    links: {
      website: 'https://arbhunter.dev',
    },
    metaTitle: 'ArbHunter - AI Ad Arbitrage Platform | Bill Kamanzi',
    metaDescription: 'AI-powered ad arbitrage platform for niche discovery, creative generation, and campaign management.',
    keywords: ['ad arbitrage', 'SaaS', 'AI', 'performance marketing', 'Next.js'],
  },
  {
    id: 'cravd',
    slug: 'cravd',
    ...
    client: 'Co-founder',
    year: '2025–2026',
    category: ['Full-Stack', 'Next.js', 'Startup', 'Mobile-First'],
    description: 'Social food rating app for Dubai: tier-based meal ratings (S to C), friend-based discovery, and vibe-based restaurant recommendations. Currently building.',
    longDescription: 'Cravd reimagines how people in Dubai discover and share food experiences. Instead of traditional star ratings, meals are rated on a tier system (S through C) that makes recommendations more meaningful. The app focuses on friend-based discovery, what your actual circle is eating, and vibe-based filtering to match restaurants to your mood.',
    heroImage: '/images/projects/cravd/cravd-screenshot-homepage.png',
    logo: '/images/projects/cravd/cravd-icon.png',
    images: [
      '/images/projects/cravd/cravd-screenshot-homepage.png',
    ],
    gradientFrom: '#3c71ec',
    gradientTo: '#2b5ad4',
    overview: 'Dubai\'s food scene is massive but discovering great meals still relies on generic review platforms. Cravd solves this by building a social layer around food: tier-based ratings that actually mean something, recommendations from people you trust, and vibe-based search that matches your mood.',
    myRole: [
      ...
      'User research & validation in Dubai market',
    ],
    results: [],
    services: ['Product Development', 'UI/UX Design', 'Full-Stack Development'],
    technologies: ['Next.js', 'TypeScript', 'Supabase', 'PostgreSQL', 'Tailwind CSS', 'Framer Motion'],
    links: {
      website: 'https://cravd.io',
    },
    metaTitle: 'Cravd - Social Food Rating App | Bill Kamanzi',
    metaDescription: 'Social food rating app for Dubai with tier-based meal ratings and friend-based discovery.',
    keywords: ['food app', 'Dubai', 'startup', 'social', 'restaurant ratings'],
  },
  {
    id: 'quackr',
    slug: 'quackr',
    ...
    heroImage: '/images/projects/quackr/quackr-homepage-screenshot.png',
    logo: '/images/projects/quackr/quackr-icon-logo.png',
    cardLogo: '/images/projects/quackr/quackr-icon-logo.png',
  ...
  },
  {
    ...
    logo: '/images/projects/uvc/uvc-logo.jpeg',
    cardLogo: '/images/projects/uvc/uvc-logo.jpeg',
